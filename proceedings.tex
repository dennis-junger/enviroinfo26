...
{A1-1}
{Pawe{\l} Kobiela \and Jaros{\l}aw Sta\'nczak \and Pawe{\l} Bartoszczuk}
{AI model of a photovoltaic installation}

\addpaper[Koch de Souza \and Engstler]
[Environmentally Informed GenAI Use in ITSM:]
{A1-2}
...
[AI in German Municipal Wastewater Facilities]
{A1-3}
...
\addpaper[Fellinger]
[Assessing the Maturity of Sustainability-aware Data]
{A2-1}
{Engelbert Fellinger}
{Assessing the Maturity of Sustainability-aware Data Management Strategies that minimise Data Volumes and reduce Energy Consumption}

\addpaper[Flohr et al.]
[Linking Water Quality to Corrosion Behaviour]
{A2-2}
...
\addpaper[Elfeky]
[Life-Cycle Decision Support for Post-Optimization]
{A3-1}
{Ahmed Elfeky}
...
[Common and Domain-Specific Design Patterns]
{A3-2}
...
\addpaper[Nachtsheim \and Arndt]
[Time-Variable State Spaces for Auditable ESG]
{A3-4}
{Ren\'{e} Nachtsheim \and Hans-Knud Arndt}
{Time-Variable State Spaces for Auditable ESG and Taxonomy Evidence in Operational Information Systems}

\addpaper[Sza{\l}ata et al.]
[Air Quality Knowledge as a Driver]
{A3-5}
{{\L}ukasz Sza{\l}ata \and Grit Behrens \and Cezary Or{\l}owski \and Rafa{\l} Grzeszczyk}
...
[Windows Integration into the Green Metrics Tool]
{A4-1}
...
[Joint Evaluation of the Green Coding Roadmap]
{A4-2}
{Nick Kriesing Garcia \and Dennis Junger \and Volker Wohlgemuth}
{Joint Evaluation of the Green Coding Roadmap Training}

\addpaper[Valko \and Marx G\'{o}mez]
[Toward a Framework for Performance and Carbon Footprint]
{A4-3}
{Danila Valko \and Jorge Marx G\'{o}mez}
...
[Towards a Taxonomy of ICT and Software Sustainability]
{A4-4}
